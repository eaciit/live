...
<head>
    ...
    <style>
        ...
        #logo > #titlelogo{
            background: url(/static/img/eaciitlive3.png) no-repeat;
            width: 170px;
            height: 80px;
            margin-left: 55px;
    ...
    <script id="navbarTemplate" type="text/html">
        ...
        <li data-bind="css:{selected:$root.PageId()==_id()}" class="dropdown">
            <a data-bind="text: Title, attr:{urllink:Url}" style="cursor:pointer" class="dropdown-toggle" data-toggle="dropdown"></a>
            <ul class="dropdown-menu" role="menu" data-bind="template:{name:'navbarSubTemplate', foreach:Submenus}, hovernavbar:'aa'"></ul>
        </li>
        <!-- /ko -->
    </script>
...
<body>
    ...
    <div class="container-fluid" style="display:none" data-bind="visible:!Processing()">
        ...
        <header id="page-header">
            ...
            <section id="user-nav">
                <div class="user-nav-wrapper">
                    <a href="#" class="user-nav-info" data-toggle="dropdown">Welcome <span>EACIIT<!-- {{.UserID}} --></span></a>
        ...
        <script>
            ...
            model.MenuList  = [ 
                {_id:"Dashboard",Url:"/",Title:"Dashboard",Submenus:[]},
                // {_id:"Home",Url:"/Home",Title:"Hypothesis",Submenus:[]},
                ...
                //     {_id:"H1ComparisonHypothesis",Url:"/h1",Title:"H1",Submenus:[]},
                //     {_id:"H2ComparisonHypothesis",Url:"/h2",Title:"H2",Submenus:[]},
                //     {_id:"H3ComparisonHypothesis",Url:"/h3",Title:"H3",Submenus:[]},
                //     {_id:"H4ComparisonHypothesis",Url:"/h4",Title:"H4",Submenus:[]},
                //     // {_id:"H5ComparisonHypothesis",Url:"/#",Title:"H5",Submenus:[]},
                //     {_id:"H6ComparisonHypothesis",Url:"/h6",Title:"H6",Submenus:[]}
                // ]},
                // {_id:"ValueHypothesis",Url:"/Hypothesis?PageId=ValueHypothesis&PageTitle=Value Hypothesis",Title:"Value Hypothesis",Submenus:[
                //     // {_id:"H7ValueHypothesis",Url:"/#",Title:"H7",Submenus:[]},
                //     {_id:"H8ValueHypothesis",Url:"/h8",Title:"H8",Submenus:[]},
                //     // {_id:"H9ValueHypothesis",Url:"/#",Title:"H9",Submenus:[]},
                //     {_id:"H10ValueHypothesis",Url:"/h10",Title:"H10",Submenus:[]},
                //     // {_id:"H11ValueHypothesis",Url:"/#",Title:"H11",Submenus:[]},
                //     // {_id:"H12ValueHypothesis",Url:"/#",Title:"H12",Submenus:[]},
                //     // {_id:"H13ValueHypothesis",Url:"/#",Title:"H13",Submenus:[]}
                // ]},
                ...
                //     {_id:"H7ValueHypothesis",Url:"/h14",Title:"H14",Submenus:[]},
                //     {_id:"H7ValueHypothesis",Url:"/h15",Title:"H15",Submenus:[]},
                //     {_id:"H7ValueHypothesis",Url:"/h16",Title:"H16",Submenus:[]},
                //     {_id:"H7ValueHypothesis",Url:"/h17",Title:"H17",Submenus:[]},
                //     {_id:"H7ValueHypothesis",Url:"/h18",Title:"H18",Submenus:[]},
                // ]},
    ...
    <script>
        ...
        ko.bindingHandlers.hovernavbar = {
            init: function (element, valueAccessor, allBindingsAccessor) {
                function showElemenFunc() {
                    $(this).addClass("open");
                    $(this).find('a.dropdown-toggle').attr({ 'aria-expanded': "true" });
                }
                function hideElemenFunc() {
                    $(this).removeClass("open");
                    $(this).find('a.dropdown-toggle').attr({ 'aria-expanded': "false" });
                }

                var hideElement = hideElemenFunc;
                var showElement = showElemenFunc;
                var $hoverTarget = $(".navbar li.dropdown");
        ...
        $("#navbar>ul").on("click","li.dropdown",function(){
            location.href = $(this).find("a.dropdown-toggle").attr("urllink");
        });
